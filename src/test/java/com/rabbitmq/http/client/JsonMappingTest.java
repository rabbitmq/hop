...
public class JsonMappingTest {
    ...
    @Test
    void jsonDocumentForQueueWithNaNMessageCountShouldReturnNegativeOneForMessageCount() throws IOException {
    ...
    @Test
    void jsonDocumentForQueueWithDefinedMessageCountShouldReturnAppropriateValue() throws IOException {
    ...
    void fieldsForClassicHaQueueShouldBeMappedCorrectly() throws IOException {
        ...
        assertThat(queue.getSynchronisedMirrorNodes()).containsExactly("rabbit-3@host3", "rabbit-2@host2");
    }
    ...
    void fieldsForQuorumQueueShouldBeMappedCorrectly() throws IOException {
        ...
        assertThat(queue.getMemberNodes()).containsExactly("rabbit-3@host3", "rabbit-2@host2", "rabbit-1@host1");
    }

    @ParameterizedTest
    @ValueSource(strings = {
            JSON_USER_WITH_USER_TAGS_AS_ARRAY,
            JSON_USER_WITH_USER_TAGS_AS_STRING
    })
    ...
    @ParameterizedTest
    @ValueSource(strings = {
            JSON_USER_WITH_USER_TAGS_AS_EMPTY_ARRAY,
            JSON_USER_WITH_USER_TAGS_AS_EMPTY_STRING
    })
    ...
    void consumerDetailsShouldDeserializeWithoutErrors() throws IOException {
        ...
        assertThat(consumer.getChannelDetails().getConnectionName()).isEqualTo("127.0.0.1:40548 -> 127.0.0.1:5672");
        assertThat(consumer.getChannelDetails().getName()).isEqualTo("127.0.0.1:40548 -> 127.0.0.1:5672 (1)");
    ...
    void channelDetailsWithUndefinedPeerPortShouldDeserializeWithoutErrors() throws IOException {
        ...
        ConsumerDetails consumer = mapper.readValue(JSON_CONSUMER_DETAILS_WITH_UNDEFINED_CHANNEL_PEER_PORT, ConsumerDetails.class);
