...
image:https://github.com/rabbitmq/hop/actions/workflows/test-3.11-stable.yml/badge.svg["Build Status", link="https://github.com/rabbitmq/hop/actions/workflows/test-3.11-stable.yml"]
