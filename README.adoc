...
:reactor-netty-version: 1.3.6
:hop-snapshot: 5.7.0-SNAPSHOT
:jackson-for-snapshot: 2.22.1
...
Project artifacts are available from https://central.sonatype.com/artifact/com.rabbitmq/http-client[Maven Central].
...
[source,sh]
----
docker run -it --rm --name rabbitmq -p 5672:5672 -p 15672:15672 rabbitmq:4.2-management
----
