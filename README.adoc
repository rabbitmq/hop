...
As of 4.0, Hop requires Java 11 or more.
...
Hostname verification can be disabled _globally_ with the https://bugs.openjdk.java.net/browse/JDK-8213309[`jdk.internal.httpclient.disableHostnameVerification` system property], but at no cost in a production environment.
